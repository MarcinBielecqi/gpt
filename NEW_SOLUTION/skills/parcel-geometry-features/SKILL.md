# Skill: Parcel Geometry Features

## Cel

Liczy cechy geometrii działek na podstawie `canon_parcel_polygon_points`.
...
| Parametr | Opis |
|---|---|
| `--parcel-id` | Opcjonalnie jedna działka zamiast artefaktu wejściowego. |
...
runs/<run_id>/skills/parcel_geometry_features/run.sqlite
```
...
| `artifact_type` | Opis |
|---|---|
| `geometry_features` | Cechy geometrii działek. |
