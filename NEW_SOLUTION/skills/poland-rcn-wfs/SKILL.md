# Skill: Poland RCN WFS

## Cel

Agreguje kanoniczne obserwacje cenowe RCN dla wybranych działek.
...
| Parametr | Opis |
|---|---|
| `--bbox-4326` | Opcjonalny bbox jako metadane wykonania. |
...
runs/<run_id>/skills/poland_rcn_wfs/run.sqlite
```
...
| `artifact_type` | Opis |
|---|---|
| `rcn_summary` | Zagregowane ceny i liczności RCN. |
